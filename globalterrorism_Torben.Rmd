...
globalterrorism_donea <- completeFun(globalterrorism_done, "longitude")
globalterrorism_doneb <- completeFun(globalterrorism_donea, "latitude")

(sites <- st_as_sf(globalterrorism_doneb, coords = c("longitude", "latitude"), 
