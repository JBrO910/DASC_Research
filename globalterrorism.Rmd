...
#globalterrorism_test <- globalterrorism %>% select_if(is.numeric)
globalterrorism_test <- globalterrorism %>% select(matches(na_percentage_filtered$rn))
globalterrorism_test
```
